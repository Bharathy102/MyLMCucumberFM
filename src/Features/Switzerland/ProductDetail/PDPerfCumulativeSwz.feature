...
Scenario: C2277:Product detail Cumulative Performance validation
	...
	And I click on Cumulative tab under Performance section for German site
	Then I verify the "cumulative-performance cumulative-performance-jewqu" Performance table is displayed with header for German site
