@pdInitForm @productdetail @uk @dk @sw @fn @nr @nl @lu @pduk @aa @sg
Feature: C1993:Product detail Literature - Initial Application Form validation

Scenario: C1993:Product detail Literature - Initial Application Form validation
	...
	And  I click on the Initial Application Form link
