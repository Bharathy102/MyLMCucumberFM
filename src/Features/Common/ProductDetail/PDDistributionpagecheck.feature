@pdDistPageData @productdetail @uk @dk @sw @fn @nr @nl @lu @pduk @aa @sg @tst
Feature: C1929 ProductDetail Distributions Page With Data Check

Scenario: C1929 Verify ProductDetail Distributions Page With Data Check
	...
	Then I click on the "Legg Mason Brandywine Global Income Optimiser Fund" in the productlist page under overview tab
	And I wait for the complete page load
