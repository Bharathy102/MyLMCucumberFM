...
Scenario: C2278:Product detail Calendar Performance validation
	...
	And I click on Calendar tab under Performance section for France site
    ...
    Then I verify the Benchmark header is displayed as Benchmark on "calendar-performance calendar-performance" table for France site