...
Scenario: C2279:Product detail Annualised Performance validation
	...
	And I click on Annualised tab under Performance section for France site
	...
	Then I verify the Benchmark header is displayed as Benchmark on "annualised-performance annualised-performance" table for France site