...
Scenario: C2259 Verify Grid/List View in MarketInsights
  ...
  And I Verify Sort By DropDown Section is available or not in Market Insight page
	...
	And I wait for the complete page load
	And I Verify List view layout header-Page for France site
	And I Verify List view layout header-Eyebrow for France site
	And I Verify List view layout header-Description for France site
	And I Verify List view layout header-Date for France site
