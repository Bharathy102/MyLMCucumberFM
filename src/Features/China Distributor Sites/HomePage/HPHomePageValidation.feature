@homepage @chdistributor @nonprodch
Feature: C1969 Global Home Page Functionality for China distributed sites
	As an author I want to verify the the home page in publisher site

Scenario: C1969 Verify the Header in Home Page for China distributed sites
